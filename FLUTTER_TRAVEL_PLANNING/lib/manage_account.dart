...
class _manage_accountState extends State<manage_account> with InputValidationMixin{
  ...
  late String strGenderSelected ="Male";
  ...
  void loadData() async{
    await FirebaseDatabase.instance.ref()
      ...
      try {
        ...
        try {
          Map<dynamic,dynamic> value =  response.value as Map;
          dataUser = ModelUser.fromJson(value);
          setState(() {
            txtName.text = dataUser.name;
            txtLastName.text = dataUser.lastname;
            txtDateOfBirth.text = dataUser.date_of_birth;
            if(dataUser.gender!= "" && dataUser.gender!= "null"){
              selectedGender = dataUser.gender;
            }
            if(dataUser.phone_number != null) {
              txtPhoneNumber.text = dataUser.phone_number;
            }
              txtEmail.text = dataUser.email;
              txtAddress.text = dataUser.address;
                                      ...
                                      children: <Widget>[
                                        ...
                                        Expanded(
                                          ...
                                          DropdownButtonFormField2(
                                            ...
                                            value: selectedGender != null ? selectedGender :"Male",
                                          ),
                                        ...
                                        Expanded(
                                          child: ElevatedButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              if(txtName.text == "" || txtLastName.text =="" || txtDateOfBirth.text =="" || selectedGender == "" || txtPhoneNumber.text == "" || txtEmail.text == "" || txtPassword == "" || txtAddress.text == "") {
