...
class travel_visited_world extends StatefulWidget {

  final String strTravelIDUpdate;
  travel_visited_world(this.strTravelIDUpdate, {Key? key}) : super(key: key);
  @override
  _travel_visited_worldState createState() => _travel_visited_worldState(this.strTravelIDUpdate);
}

class _travel_visited_worldState extends State<travel_visited_world> {
  ...
  _travel_visited_worldState(strTravelIDUpdate);
...
class ModelTravelWorld {
  ...
  ModelTravelWorld(this.travel_world_id, this.title,this.country);
