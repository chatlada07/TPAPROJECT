...
class travel_world extends StatefulWidget {

  final String strTravelIDUpdate;
  final String  strTravelTitle_Update;
  travel_world(this.strTravelIDUpdate,this.strTravelTitle_Update, {Key? key}) : super(key: key);
  @override
  _travel_worldState createState() => _travel_worldState(this.strTravelIDUpdate,this.strTravelTitle_Update);
}

class _travel_worldState extends State<travel_world> {
  ...
  _travel_worldState(String strTravelIDUpdate, String strTravelTitle_Update);
  ...
  void initState() {
    ...
    //   shapeColorValueMapper: (int index) => dataMap[index].color,
    //   shapeColorMappers: [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(widget.strTravelIDUpdate != "" ? "Edit Travel Aboard" : "Travel Aboard",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold)),
                                        ...
                                        children: new List<InkWell>.generate(
                                            itemTravelWorld.length,
                                              ...
                                              return widget.strTravelIDUpdate == "" ? InkWell(
                                                onTap: (){
                                                  _pushPageChecklist(context,false,"",itemTravelWorld[index].travel_world_id,dataMap);
                                                },
                                                child: Container(
  ...
  _pushPageTravel(BuildContext context, bool isHorizontalNavigation, String travel_world_id, String title) {
    Navigator.of(context, rootNavigator: !isHorizontalNavigation).push(
      _buildAdaptivePageRoute(
        builder: (context) => travel_world(travel_world_id,title),
